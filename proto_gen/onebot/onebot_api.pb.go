...
var file_onebot_api_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x6f, 0x6e, 0x65, 0x62, 0x6f, 0x74, 0x62,
...
var file_onebot_api_proto_depIdxs = []int32{
	...
	86, // 1: onebot.SendGroupMsgReq.message:type_name -> onebot.Message
	86, // 2: onebot.SendMsgReq.message:type_name -> onebot.Message
	78, // 3: onebot.GetMsgResp.sender:type_name -> onebot.GetMsgResp.Sender
	86, // 4: onebot.GetMsgResp.message:type_name -> onebot.Message
	79, // 5: onebot.SetGroupAnonymousBanReq.anonymous:type_name -> onebot.SetGroupAnonymousBanReq.Anonymous
	80, // 6: onebot.GetFriendListResp.friend:type_name -> onebot.GetFriendListResp.Friend
	81, // 7: onebot.GetGroupListResp.group:type_name -> onebot.GetGroupListResp.Group
	82, // 8: onebot.GetGroupMemberListResp.group_member:type_name -> onebot.GetGroupMemberListResp.GroupMember
	83, // 9: onebot.GetGroupHonorInfoResp.current_talkative:type_name -> onebot.GetGroupHonorInfoResp.CurrentTalkative
	84, // 10: onebot.GetGroupHonorInfoResp.talkative:type_name -> onebot.GetGroupHonorInfoResp.Honor
	84, // 11: onebot.GetGroupHonorInfoResp.performer:type_name -> onebot.GetGroupHonorInfoResp.Honor
	84, // 12: onebot.GetGroupHonorInfoResp.legend:type_name -> onebot.GetGroupHonorInfoResp.Honor
	84, // 13: onebot.GetGroupHonorInfoResp.strong_newbie:type_name -> onebot.GetGroupHonorInfoResp.Honor
	84, // 14: onebot.GetGroupHonorInfoResp.emotion:type_name -> onebot.GetGroupHonorInfoResp.Honor
	85, // 15: onebot.GetVersionInfoResp.extra:type_name -> onebot.GetVersionInfoResp.ExtraEntry
